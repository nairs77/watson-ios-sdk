...
extension ToneAnalyzer {
     ...
     */
    public struct ElementTone {
        
        /// The tone analysis categories. Possible tone categories are emotion, writing, and social.
        public var tones:[ToneCategory] = []
        
        init(anyObject: AnyObject) {
            let jsonToneCategories = anyObject["tone_categories"] as! [AnyObject]
            for tone in jsonToneCategories {
                tones.append(ToneCategory.init(anyObject: tone))
            }
        }
    }
}
